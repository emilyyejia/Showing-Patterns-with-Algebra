          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 animate-fade-in">
            <div className="flex flex-col items-center">
              <div className="bg-white p-6 rounded-xl w-full shadow-inner border-2 border-slate-200">
                <h2 className="text-sm font-bold text-gray-500 tracking-widest mb-4 text-center">social media growth</h2>
              ...
              <div className={qIndex >= 0 ? 'opacity-100' : 'opacity-20 pointer-events-none'}>
                ...
                {qIndex === 0 ? (
                  <div className="grid gap-2">
                    ...
                    <button onClick={() => handleManualCheck(selected?.startsWith('B') || false, "Try again! Check the glossary to review the terms.", false)} className="mt-2 bg-sky-600 hover:bg-sky-500 p-3 rounded-xl font-black uppercase shadow-lg transition-transform active:scale-95">Check</button>
                  </div>
                ...
                <div className="animate-fade-in-up">
                  ...
                  {qIndex === 1 ? (
                    <div className="grid gap-2">
                      ...
                      <button onClick={() => handleManualCheck(selected?.startsWith('A') || false, "Try again! Check the glossary to review the terms.", true)} className="mt-2 bg-sky-600 hover:bg-sky-500 p-3 rounded-xl font-black uppercase shadow-lg transition-transform active:scale-95">Check</button>
                    </div>
        ...
        {step === 2 && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 animate-fade-in">
            ...
            <div className="space-y-4">
                ...
                <button onClick={() => handleManualCheck(selected?.startsWith('Decreases by $2') || false, "Try again! Check the glossary to review the terms.", true)} className="mt-4 w-full bg-sky-600 hover:bg-sky-500 p-4 rounded-xl font-black uppercase shadow-lg transition-transform active:scale-95">Check</button>
            </div>
          </div>
        )}
        {step === 3 && (
          <div className="flex flex-col items-center animate-fade-in text-center">
             <h2 className="text-xl font-bold mb-6 text-indigo-200">Look at the number sequence. Which statement is correct?</h2>
             ...
             <div className="w-full max-w-xl space-y-4">
                ...
                <button onClick={() => handleManualCheck(selected?.includes('by 3') || false, "Check how the number changes from one step to the next.", true)} className="w-full bg-sky-600 hover:bg-sky-500 p-4 rounded-xl font-black uppercase shadow-lg transition-transform active:scale-95">Check</button>
             </div>
          </div>
        )}
        {step === 4 && (
          <div className="animate-fade-in flex flex-col items-center">
            <div className="bg-indigo-950/30 p-8 rounded-3xl border border-indigo-400/30 mb-10 w-full text-center">
              <p className="text-2xl font-bold text-white leading-relaxed">"A phone plan includes a <span className="font-bold">base fee of $10</span> and <span className="font-bold">$1 for each text message</span>."</p>
            </div>
              ...
              <div className={qIndex >= 0 ? 'opacity-100' : 'opacity-20 pointer-events-none'}>
                ...
                {qIndex === 0 ? (
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    ...
                    <button onClick={() => handleManualCheck(selected?.startsWith('C') || false, "Try again! Check the glossary to review the terms.", false)} className="mt-2 w-full bg-sky-600 hover:bg-sky-500 p-3 rounded-xl font-black uppercase shadow-lg">Check</button>
                  </div>
                ...
                <div className="animate-fade-in-up">
                  ...
                  {qIndex === 1 ? (
                    <div className="grid gap-3">
                      ...
                      <button onClick={() => handleManualCheck(selected?.startsWith('B') || false, "Try again! Check the glossary to review the terms.", true)} className="mt-2 w-full bg-sky-600 hover:bg-sky-500 p-3 rounded-xl font-black uppercase shadow-lg">Check</button>
                    </div>
